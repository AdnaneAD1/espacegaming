...
export const GAME_MODES_CONFIG: Record<GameMode, GameModeConfig> = {
  [GameMode.BR_SQUAD]: {
    ...
    teamSize: 4,
    minPlayers: 4,
    maxPlayers: 25, // Maximum 25 équipes en BR Squad
    pointsSystem: {
      placement: {
        1: 25, 2: 20, 3: 17, 4: 15,
        ...
        76: 1, 77: 1, 78: 1, 79: 1, 80: 1, 81: 1, 82: 1, 83: 1, 84: 1, 85: 1,
  ...
  [GameMode.BR_DUO]: {
    ...
    teamSize: 2,
    minPlayers: 2,
    maxPlayers: 50, // Maximum 50 équipes en BR Duo
    pointsSystem: {
      placement: {
        1: 25, 2: 20, 3: 17, 4: 15,
        5: 12, 6: 12, 7: 12, 8: 12, 9: 12, 10: 12,
  ...
  [GameMode.BR_SOLO]: {
    ...
    teamSize: 1,
    minPlayers: 1,
    maxPlayers: 100, // Maximum 100 joueurs en BR Solo
    pointsSystem: {
      placement: {
        1: 25, 2: 20, 3: 17, 4: 15,
        5: 12, 6: 12, 7: 12, 8: 12, 9: 12, 10: 12,
